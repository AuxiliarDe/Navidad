...
usuario = {
    "email": "ventasdp2023@gmail.com",
    "password": "Ventasdp2023"
}
...
if not all_data:
    ...
    # Expandir y normalizar columnas anidadas, incluyendo las nuevas columnas
    ...
    for attempt in range(max_retries):
        try:
            dbx.files_upload(csv_buffer.getvalue().encode(), f"/A60.csv", mode=dropbox.files.WriteMode.overwrite)
            print(f"Archivo subido a Dropbox como /A60.csv")
